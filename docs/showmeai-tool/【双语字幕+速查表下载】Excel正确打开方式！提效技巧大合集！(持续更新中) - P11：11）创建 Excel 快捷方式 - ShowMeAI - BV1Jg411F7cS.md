...
This is the beginner's guide to Excel macros。 How to use macros to create shortcuts for the tasks that you need to do in Excel。
 ...
 And the spreadsheet that I'm gonna to use for this example is an employee list You can see there's a list of several employees here for a hypothetical small business。
 ...
 you might need to right click here on the ribbon and choose customize the ribbon and make sure that developer is included here。
...
There's my very descriptive description and I click OK。And I got an error message。
 ...
 I can move the mouse wherever I want to。 None of that is getting recorded。

 What gets recorded is where I click and the options and settings and things that I change in Excel。

 Okay， so what do I want it to record。 I want it to record me going from the employees spreadsheet to the projects spreadsheet。

 So I'll just click on projects。 And that's really all I want it to record。 So I'll click。

 stop recording。 And that macro has been successfully recorded。Now。

 I'm going to jump back to the employees spreadsheet。 and let's look at the macro that I've created。

 If I click here on macros， it should list all of the macros that exist in this workbook And there it is button to projects tab。

 while I'm here， I want you to notice that in that macros option that I just selected。
 ...
 So here again， on the developer tab， I'm gonna to go down to insert， and I'll click。
 ...
 It is a good idea to create a button on the second spreadsheet to take you back to the first one。
 ...
 and maybe click and drag to highlight button1。 and I'll just call this return。Now。
 ...
 mark as reviewed。 the shortcut key。 I'm going to do control shift C。 and I click， O。
...
Because I would have clicked on it after starting the recording of the macro。
 ...
 let's create a button and see if it worked。 So I'm going to go here to the developer tab insert a form control button。

 and I'll just click and drag to draw it on the screen。 And I just need to click mark as reviewed。

 click O， there's my button。 And before I forget what it means。

 I better change the name here on the button itself。 and I'll just click away from the button。

 So let's say Jimmy Kinslow and I have a great review， I can click on。name click reviewed。

 and it instantly highlighted his name in just the exact color of blue that I wanted to use。
 ...
 It'll help you easily and quickly jump from sheet to sheet。 Now， of course。
 ...
 and change it from just Excel workbook to Excel macro enabled workbook。 If you don't do that。
...
So thanks for watching。 I hope you found this tutorial to be helpful。 If you did。
